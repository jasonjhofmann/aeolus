...
- **Deferred:** induced/pressure edges (FR-X3) not yet wired into the staircase (helper retained + unit-tested); a tier-editor that round-trips *edits* of an existing ladder field-by-field (today: re-author replaces).
