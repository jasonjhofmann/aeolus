"""v3 acceptance — graduated PM ladder (FR-T) + the filter-can't-reduce-CO₂ gate.
...
async def test_kitchen_pm_ladder(hass: HomeAssistant) -> None:
    ...
    entry = MockConfigEntry(
        ...
        subentries_data=[
            ...
            ConfigSubentryData(
                ...
                unique_id=None,
                data={
                    CONF_ACTUATOR_ENTITY: "input_boolean.mud",
                    CONF_MECHANISM: "exhaust",
                },
            ),
        ],
    )
    ...
    assert drive(90) == {
        ...
        pur: 100,
        mud: 100,
    }  # jump to tier 3 — all on, max speed
    assert drive(70) == {
        hood: 100,
        pur: 100,
        mud: 100,
    }  # 70 > release 68 → holds (hysteresis)
